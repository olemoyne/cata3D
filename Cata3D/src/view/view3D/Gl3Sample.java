...
gl.glBufferData(GL3.GL_ARRAY_BUFFER, vertices1.length * Float.SIZE / 8,
Buffers.newDirectFloatBuffer(vertices1), GL3.GL_STATIC_DRAW);
...
gl.glBufferData(GL3.GL_ARRAY_BUFFER, colors1.length * Float.SIZE / 8,
Buffers.newDirectFloatBuffer(colors1), GL3.GL_STATIC_DRAW);
...
// bind buffer for vertices and copy data into buffer
gl.glBindBuffer(GL3.GL_ARRAY_BUFFER, buffers[0]);
gl.glBufferData(GL3.GL_ARRAY_BUFFER, vertices2.length * Float.SIZE / 8,
Buffers.newDirectFloatBuffer(vertices2), GL3.GL_STATIC_DRAW);
gl.glEnableVertexAttribArray(vertexLoc);
gl.glVertexAttribPointer(vertexLoc, 4, GL3.GL_FLOAT, false, 0, 0);

// bind buffer for colors and copy data into buffer
gl.glBindBuffer(GL3.GL_ARRAY_BUFFER, buffers[1]);
gl.glBufferData(GL3.GL_ARRAY_BUFFER, colors2.length * Float.SIZE / 8,
Buffers.newDirectFloatBuffer(colors2), GL3.GL_STATIC_DRAW);
gl.glEnableVertexAttribArray(colorLoc);
gl.glVertexAttribPointer(colorLoc, 4, GL3.GL_FLOAT, false, 0, 0);
