...
public class DialogExportParameters extends JDialog implements ActionListener {

	public PrintingParameters exportFileDest;
	public boolean isOk;
	 ...
	 * @param pnl
	 */
	public DialogExportParameters(JFrame frm, PrintingParameters p) {
		super(frm, true);
		exportFileDest = p;
		...
		if (p != null) editeur.setText(exportFileDest.fileName);
		centre.add(editeur);
	...
	public void actionPerformed(ActionEvent arg0) {
		if (arg0.getActionCommand().equals("Valide")) {
			this.exportFileDest.fileName = editeur.getText();
