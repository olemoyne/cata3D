...
public class PatchTreeNode extends ComposantTreeNode {
	...
	public ArrayList<TreeNodeProperty> getProperties() {
		...
		ret.add(new TreeNodeProperty ("Pr√©cision", p.precision, true, ObjectUpdater.INTEGER) );
		ret.add(new TreeNodeProperty ("SymÈrtie", p.reflexive, true, ObjectUpdater.BOOLEAN) );
		return ret;
	}
